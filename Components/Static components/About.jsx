    ...
    <div >
      ...
      <div className="h-[100vh] ">
        <div className="flex justify-center flex-col m-3 items-center">
          <div className="font-medium bg-[#a8cbff] text-3xl s:text-4xl l:text-5xl m-4 lg:m-5 underline rounded py-1 px-2 inline-block ">
            About Nearmistry
          </div>
          ...
          <div className="font-medium text-2xl m-4 bg-[#a3c4f5] lg:my-4 underline rounded py-1 px-2 inline-block ">
            Our Vision
          </div>
          <p className="text-xl mt-3 mb-3 font-semibold lg:max-w-4xl text-center">
